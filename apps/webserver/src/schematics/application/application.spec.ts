...
describe("app", () => {
  ...
  describe("not nested", () => {
    it("should update workspace.json", async () => {
                ...
                fileReplacements: [
                  {
                    ...
                    with: "apps/my-webserver-app/src/environments/environment.prod.ts",
                  },
                ],
              },
              development: {
      ...
      expect(workspaceJson.projects["my-webserver-app"].architect.lint).toEqual({
        ...
        options: {
          ...
          tsConfig: ["apps/my-webserver-app/tsconfig.app.json", "apps/my-webserver-app/tsconfig.spec.json"],
    ...
    it("should update nx.json", async () => {
      const tree = await runSchematic(webserverTestRunner, "app", { name: "myWebserverApp", tags: "one,two" }, appTree);
    ...
    it("should generate files", async () => {
      ...
      const tsconfigApp = JSON.parse(
        stripJsonComments(getFileContent(tree, "apps/my-webserver-app/tsconfig.app.json")),
      );
      expect(tsconfigApp.compilerOptions.outDir).toEqual("../../dist/out-tsc");
      expect(tsconfigApp.extends).toEqual("./tsconfig.json");

      const eslintrc = JSON.parse(stripJsonComments(getFileContent(tree, "apps/my-webserver-app/.eslintrc")));
  ...
  describe("nested", () => {
    it("should update workspace.json", async () => {
      ...
      expect(workspaceJson.projects["my-dir-my-webserver-app"].root).toEqual("apps/my-dir/my-webserver-app");

      expect(workspaceJson.projects["my-dir-my-webserver-app"].architect.lint).toEqual({
        builder: "@nrwl/linter:lint",
        options: {
    ...
    it("should generate files", async () => {
      ...
      [`apps/my-dir/my-webserver-app/jest.config.js`, "apps/my-dir/my-webserver-app/src/main.ts"].forEach(path => {
  ...
  describe("--unit-test-runner none", () => {
    it("should not generate test configuration", async () => {
      ...
      const workspaceJson = readJsonInTree(tree, "workspace.json");
      expect(workspaceJson.projects["my-webserver-app"].architect.test).toBeUndefined();
      expect(workspaceJson.projects["my-webserver-app"].architect.lint.options.tsConfig).toEqual([
