...
describe("app", () => {
  ...
  describe("not nested", () => {
    it("should update workspace.json", async () => {
      const tree = await runSchematic(nodeTestRunner, "app", { name: "myNodeApp" }, appTree);
      ...
      expect(workspaceJson.projects["my-node-app"].architect.lint).toEqual({
        ...
        options: {
          config: "apps/my-node-app/.eslintrc",
          tsConfig: ["apps/my-node-app/tsconfig.app.json", "apps/my-node-app/tsconfig.spec.json"],
    ...
    it("should update nx.json", async () => {
      const tree = await runSchematic(nodeTestRunner, "app", { name: "myNodeApp", tags: "one,two" }, appTree);
    ...
    it("should generate files", async () => {
      ...
      const tsconfigApp = JSON.parse(stripJsonComments(getFileContent(tree, "apps/my-node-app/tsconfig.app.json")));
      expect(tsconfigApp.compilerOptions.outDir).toEqual("../../dist/out-tsc");
      expect(tsconfigApp.extends).toEqual("./tsconfig.json");

      const eslintrc = JSON.parse(stripJsonComments(getFileContent(tree, "apps/my-node-app/.eslintrc")));
  ...
  describe("nested", () => {
    it("should update workspace.json", async () => {
      const tree = await runSchematic(nodeTestRunner, "app", { name: "myNodeApp", directory: "myDir" }, appTree);
      const workspaceJson = readJsonInTree(tree, "/workspace.json");
      ...
      expect(workspaceJson.projects["my-dir-my-node-app"].architect.lint).toEqual({
        builder: "@nrwl/linter:lint",
        options: {
          config: "apps/my-dir/my-node-app/.eslintrc",
          tsConfig: ["apps/my-dir/my-node-app/tsconfig.app.json", "apps/my-dir/my-node-app/tsconfig.spec.json"],
    ...
    it("should generate files", async () => {
      ...
      [`apps/my-dir/my-node-app/jest.config.js`, "apps/my-dir/my-node-app/src/main.ts"].forEach(path => {
  ...
  describe("--unit-test-runner none", () => {
    it("should not generate test configuration", async () => {
      const tree = await runSchematic(nodeTestRunner, "app", { name: "myNodeApp", unitTestRunner: "none" }, appTree);
      ...
      expect(workspaceJson.projects["my-node-app"].architect.lint.options.tsConfig).toEqual([
