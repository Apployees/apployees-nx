...
function getForkTsCheckerWebpackPlugin(options: IBuildNodeBuilderOptions) {
  ...
  return new ForkTsCheckerWebpackPlugin({
    ...
    resolveModuleNameModule: (process.versions as any).pnp ? pnpPluginTs : undefined,
    resolveTypeReferenceDirectiveModule: (process.versions as any).pnp ? pnpPluginTs : undefined,
